...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { codigo_producto: @producto.codigo_producto, nombre_producto: @producto.nombre_producto, pasillo_producto: @producto.pasillo_producto, precio_producto: @producto.precio_producto }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { codigo_producto: @producto.codigo_producto, nombre_producto: @producto.nombre_producto, pasillo_producto: @producto.pasillo_producto, precio_producto: @producto.precio_producto }
    assert_redirected_to producto_path(assigns(:producto))
  end
